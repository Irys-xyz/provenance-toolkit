			...
			<div className="flex flex-col text-xs space-y-1 items-start">
				...
				<div className="flex flex-col gap-4">
					...
					<div className="flex flex-col gap-2">
						...
						<code className="rounded bg-[#D8CFCA] px-2 py-1">{'<FundWithdraw config={{ currency: "ethereum" }} />'}</code>
					</div>
					<div className="flex flex-col gap-2">
						<p className="text-base text-neutral-700">To set component to fund-only:</p>
						<code className="rounded bg-[#D8CFCA] px-2 py-1">{"<FundWithdraw config={{ fundOnly: true }} />"}</code>
					</div>
					<div className="flex flex-col gap-2">
						<p className="text-base text-neutral-700">To set the component to withdraw-only:</p>
						<code className="rounded bg-[#D8CFCA] px-2 py-1">{"<FundWithdraw config={{ withdrawOnly: true }} />"}</code>
					</div>
				</div>
			</div>
		</div>
