		...
		<div className="mx-auto py-10 bg-background text-text flex flex-col-reverse gap-10 md:flex-row justify-center items-start">
			...
			<div className="flex flex-col space-y-4 p-5 rounded-lg border">
				...
				<div className="bg-[#EEF0F6]/60 rounded-lg">
					...
					<p className="mt-2">
						Before testing, set the <span className="bg-gray-200 p-1 text-xs">NEXT_PUBLIC_HELIUS_API</span> variable in{" "}
				...
				<div className="bg-[#EEF0F6]/60 rounded-lg">
					<div className="flex flex-col gap-4 text-xs">
						...
						<div className="flex flex-col gap-2">
							...
							<code className="rounded bg-[#D8CFCA] px-2 py-1">{"<SolanaNFTMinter gasless={ true } />"}</code>
							<p className="mt-2">
								If enbaled, you must also set <span className="bg-gray-200 p-1 text-xs">PRIVATE</span> variable in{" "}
								<span className="bg-gray-200 p-1 text-xs">.env.local</span>
							</p>
						</div>
					</div>
